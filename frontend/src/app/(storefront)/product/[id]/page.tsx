          ...
          <div className="flex flex-col space-y-8">
            ...
            />
              ...
              <div className="pt-10 border-t border-gray-100 space-y-4">
                <div>
                  <h3 className="text-xl md:text-2xl font-serif text-gray-900 mb-4 font-bold tracking-tight">The Design Narrative</h3>
              ...
              <div className="pt-6 space-y-0">
                <details className="group border-t border-gray-100 py-4">
                  <summary className="flex items-center justify-between list-none cursor-pointer uppercase text-[10px] font-black tracking-[0.2em] text-gray-900">
                    Artistry & Fabric
                    <ChevronDown className="w-3 h-3 group-open:rotate-180 transition-transform" />
                  </summary>
                  <p className="pt-4 text-[11px] text-gray-400 font-medium leading-relaxed">

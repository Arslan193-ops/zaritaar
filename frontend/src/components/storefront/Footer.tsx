        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="text-lg font-bold tracking-tight text-gray-900 uppercase">{storeName}</span>
            </Link>
          ...
          <div className="space-y-6">
            ...
            <nav className="flex flex-col gap-4">
              ...
              <Link href="/shop" className="text-xs font-bold text-gray-400 hover:text-black transition-colors uppercase tracking-widest">Collections</Link>
